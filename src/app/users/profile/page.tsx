...
export default function ProfilePage() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      if (!res.ok || !data || !data.name || !data.surname || !data.phone || !data.address) {
        throw new Error(data.message || "Profil bilgileriniz eksik, lütfen yöneticinizle iletişime geçin.");
      }
      setProfile(data);
    } catch (error: unknown) {
